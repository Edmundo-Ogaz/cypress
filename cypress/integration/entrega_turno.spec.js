...
describe('Attention Summary', function(){
    it('Test patient in urgency', function(){
        ...
        cy.get(':nth-child(3) > .container > textarea').should('have.not.value', '')
        cy.get(':nth-child(4) > .container > textarea').should('have.not.value', '')
        cy.get(':nth-child(5) > .container > textarea').should('have.not.value', '')
    })
})